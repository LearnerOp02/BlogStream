...
const { update, delete: deletePost, getposts, postdetails, userposts, create } = require('../controller/post');
const { createcomment, updatecomment, deletecomment, postcomment } = require('../controller/comment');
