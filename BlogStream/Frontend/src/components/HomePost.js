  ...
  return (
    <div className='card card-single shadow-lg mx-4 my-3 single-card blog-card p-3 flex-1' style={{ width: '350px', borderRadius: '15px', overflow: 'hidden', border: '1px solid #ccc' }}>
      <div className="img-container d-flex" style={{ maxHeight: '150px', minHeight: '150px' }}>
        <img src='https://tse2.mm.bing.net/th?id=OIP.YsEPA7fZ0516aowp79LtgQHaES&pid=Api&P=0&h=180' alt="Blog Post" className="card-img-top" style={{ objectFit: 'cover', borderTopLeftRadius: '15px', borderTopRightRadius: '15px' }} />
      </div>
      ...
      <div className="card-body p-4">
        ...
        <div className="d-flex justify-content-between m-2">
          <p className="small text-muted">20/10/2008</p>
          <p className="small text-muted">5 min read</p>
        </div>
        ...
        <div className="links d-flex justify-content-between align-items-center m-0 p-1">
          <p className="small pb-0 pt-1 m-0 text-primary" style={{ fontWeight: "700" }}>Author Name</p>
          <Link to='/posts/post/:id'><span className="py-0 text-primary" style={{ cursor: 'pointer', textDecoration: 'underline', fontSize: '14px' }}>
            Read more
          </span></Link>
        </div>
      </div>
